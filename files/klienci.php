...
$sql = 'select id,imie,nazwisko,pesel,ulica,miejscowosc,kod_pocztowy,telefon from klient';
  ...
  <div id="main-dashboard">
      ...
      <table id='myTable' class="table table-striped table-bordered">
        ...
        <tbody>
          ...
          while ($row = mysqli_fetch_assoc($query)) {
            ...
            printf("<td><button class='btn btn-warning' id='%s' onclick='deleteUser(%s)'>Usuń</button></td>", $id, $id);
            echo '</tr>';
          }
          ?>
        </tbody>
    ...
    <div id='bg'
      ...
      <div
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            <button type="submit" class="btn btn-primary w-75" onclick="insert()">Dodaj</button>
          </div>
          <div class="form-group col-md-6">
    ...
    <button class='btn' id="addNewItem">Dodaj nowego klienta</button>
  </div>
    ...
    function insert() {
      $.ajax({
        ...
        success: function (response) {
          window.location.replace("klienci.php");
        }
      });
    }
